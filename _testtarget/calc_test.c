// NO DEBUG-INFO:
// clang -target x86_64-apple-macos -arch x86_64 -o calc_test calc_test.c -isysroot $(xcrun --show-sdk-path)
//
// WITH DEBUG-INFO:
// clang -g -target x86_64-apple-macos -arch x86_64 -o calc_test calc_test.c -isysroot $(xcrun --show-sdk-path)
//
// Make executable:
