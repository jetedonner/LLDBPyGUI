# LLDBGUI - Tips and tricks

LLDBGUI is a python GUI for LLDB - implemented with PyQt6. (This is a LLDB internal script with custom commands and a
include version of lldbinit)
