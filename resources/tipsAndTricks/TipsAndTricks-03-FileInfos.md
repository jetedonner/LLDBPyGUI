...
The file infos tab shows you essential information about the target app like file header, structure, linked modules,
signatures, load command and entitlements as well as file statistics and more.
