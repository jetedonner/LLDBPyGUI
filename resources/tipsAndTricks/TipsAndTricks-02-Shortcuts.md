# LLDBGUI - Shortcuts, Tooltips, HOvers and Helpers

LLDBGUI features some essential and really helpful shortcuts (keyboard and click), tooltips and hover that provide
context sensitive information of the current GUI situation you don't want to miss. They are part of the Key-Concept of
LLDBGUI and make your life working with the app way easier.
...
Almost all texts in almost all widgets you can copy by pressing **SHIFT-CLICK** (Shift-Key combined with a click).
