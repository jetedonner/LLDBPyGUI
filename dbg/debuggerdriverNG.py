...
class EventListenerController(QObject):
    ...
    def __init__(self, parent, debugger):
        ...
        self.thread = EventListenerQThread(parent)
        # Step 3: Create a worker object
        self.worker = EventListenerWorker(parent, debugger)
        self.worker.setupListeners()
...
class EventListenerWorker(QObject):
    ...
    def run(self):
        print(f"HERE WE ARE !!!!!! ===>>> Worker.run()")
        ...
        #     print(f"HERE WE ARE !!!!!! ===>>> Worker.progress.emit({i + 1})")
        #     QApplication.processEvents()
        # print(f"HERE WE ARE !!!!!! ===>>> Worker.finished.emit()")
        print(f"HERE WE ARE !!!!!! ===>>> Worker.run() ===>>> Worker.finished ...")
        self.finished.emit()
